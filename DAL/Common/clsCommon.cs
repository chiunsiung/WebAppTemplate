...
namespace DAL
{
    public class clsCommon
    {
        ...
        public static DateTime UnixTimeStampToDateTime(string unixTimeStamp)
        {
            ...
            long unix = long.Parse(unixTimeStamp);
        ...
        public static string ToDateTime2(object obj)
        {
            try
            {
                return Convert.ToDateTime(obj.ToString()).ToString(clsConst.constDate_DateTimeFmt);
            }
            catch (Exception ex)
            {
                return Convert.ToDateTime("1900-01-01").ToString(clsConst.constDate_DateTimeFmt);
            }
